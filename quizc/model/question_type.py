...
class TextConfiguration(QuestionConfiguration):
    def __init__(self):
        QuestionConfiguration.__init__(
            self, False, [ValidatorType.REQUIRED, ValidatorType.MIN_LENGTH, ValidatorType.MAX_LENGTH, ValidatorType.UPPERCASE])
...
class DateConfiguration(QuestionConfiguration):
    ...
    def __init__(self):
        QuestionConfiguration.__init__(
            self, False, [ValidatorType.REQUIRED, ValidatorType.DATE])
...
# Modificacion para la tarea 1


class NumericoConfiguration(QuestionConfiguration):
    def __init__(self):
        QuestionConfiguration.__init__(
            self, False, [ValidatorType.REQUIRED, ValidatorType.MIN])
...
class QuestionType(Enum):
    ...
    NUMERIC = (4, NumericoConfiguration())
